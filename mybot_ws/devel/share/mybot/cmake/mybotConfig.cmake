...
if("TRUE" STREQUAL "TRUE")
  set(mybot_SOURCE_PREFIX /home/anhle/mybot_ws/src/mybot)
  set(mybot_DEVEL_PREFIX /home/anhle/mybot_ws/devel)
  set(mybot_INSTALL_PREFIX "")
  set(mybot_PREFIX ${mybot_DEVEL_PREFIX})
else()
  set(mybot_SOURCE_PREFIX "")
  set(mybot_DEVEL_PREFIX "")
  set(mybot_INSTALL_PREFIX /home/anhle/mybot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anhle/mybot_ws/src/mybot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mybot_NUM_DUMMY_TARGETS)
      set(mybot_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mybot::wrapped-linker-option${mybot_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mybot_NUM_DUMMY_TARGETS "${mybot_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mybot::wrapped-linker-option${mybot_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mybot_LIBRARIES "${interface_target_name}")
