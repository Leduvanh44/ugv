...
def control_adaptive_los(current_x, current_y, current_theta, goal_x, goal_y, next_goal_x=None, next_goal_y=None, next_next_goal_x=None, next_next_goal_y=None):
    ...
    # if next_goal_x is not None and next_goal_y is not None:
    #     next_target_heading = get_heading(goal_x, goal_y, next_goal_x, next_goal_y)
    #     target_heading = (target_heading + next_target_heading) / 2

    # if next_next_goal_x is not None and next_next_goal_y is not None:
    #     next_target_heading = get_heading(current_x, current_y, next_goal_x, next_goal_y)
    #     next_next_target_heading = get_heading(current_x, current_y, next_next_goal_x, next_next_goal_y)
    #     target_heading = (target_heading + next_next_target_heading + next_target_heading) / 3
    # rospy.loginfo("heading: {},{}".format(target_heading, next_target_heading))
